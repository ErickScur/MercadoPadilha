...
<html lang="en">
  ...
  <body>
    ...
    <table border="1" width="800" class="table-hover table-bordered table-striped">
		...
		<?php
		$sql = $pdo->prepare("SELECT * FROM boleto");
		$sql->execute();
		...
		if($sql->rowCount() > 0) {
			foreach($sql->fetchAll() as $item) {
				...
				<tr>
                    ...
                    <td>
                        <?php $id = $item['id'] ;
                        echo '<a href="editarboleto.php?id='.$id.'">Editar</a> <a href="excluirboleto.php?id='.$id.'">Excluir</a>'
                        ?>
                    </td>
                </tr>
    ...
    <a name="" id="" class="btn btn-primary" href="cadastrarboleto.php" role="button">Inserir  boleto</a><br>
    <br>
    <br>
    <br>
    <br>
    ...
    <a name="" id="" class="btn btn-danger" role="button" onclick="confirmar(4)">Apagar tudo</a>
