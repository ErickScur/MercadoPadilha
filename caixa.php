...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
            <h1 class="display-3">Vendas caixa</h1>
    ...
    <table border="1" width="800" class="table-hover table-bordered table-striped">
		...
		<?php
		$sql = $pdo->prepare("SELECT * FROM caixa");
		$sql->execute();
		...
		if($sql->rowCount() > 0) {
			foreach($sql->fetchAll() as $item) {
				...
				<tr>
                    ...
                    <td>
                        <?php $id = $item['id'] ;
                        echo '<a href="editarCaixa.php?id='.$id.'">Editar</a> <a href="excluirCaixa.php?id='.$id.'">Excluir</a>'
                        ?>
                    </td>
                </tr>
    ...
    <a name="" id="" class="btn btn-primary" href="cadastrarCaixa.php" role="button">Inserir vendas caixa</a><br>
    <br>
    <br>
    <br>
    <br>
    <script src="script.js" type="text/javascript"></script>
    <a name="" id="" class="btn btn-danger" role="button" onclick="confirmar(1)">Apagar tudo</a>
    </div>
