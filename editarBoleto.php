<?php
   ...
   if(isset($_POST['valor'])){
    ...
    $valor = floatval($valor);
       ...
       $sql = "UPDATE boleto SET valor = '$valor', vencimento = '$vencimento', fornecedor = '$fornecedor'  WHERE id = '$id'  ";
       $pdo->query($sql);
    ...
    $sql = $pdo->query("SELECT * FROM boleto WHERE id = '$id'");
...
<h2>Editar</h2>
        <form method="post">
            ...
            <input type="submit" value="Atualizar boleto">
